class Family < ApplicationRecord
  include PlaidConnectable, SimplefinConnectable, LunchflowConnectable, EnableBankingConnectable, PriorbankConnectable, Syncable, AutoTransferMatchable, Subscribeable
